...
Materials by [Dirk Wulff](https://www.mpib-berlin.mpg.de/person/93374/2549) and [Zak Hussain](https://zak-hussain.github.io/). Taught in-person by Zak Hussain. 
...
11:30 AM - 12:00 PM: [Exercise: Running pipelines](day_1/day_1a.ipynb)<br>
12:00 PM - 01:00 PM: Lunch<br>
01:00 PM - 01:30 PM: Walkthrough<br>
01:30 PM - 02:00 PM: [Talk: Intro to transformers & embeddings](day_1/day_1c.pdf)<br>
02:00 PM - 02:15 PM: Break<br>
02:15 PM - 03:00 PM: [Talk: Intro to transformers & embeddings (continued)](day_1/day_1c.pdf)<br>
03:00 PM - 04:00 PM: [Exercise: Clarifying personality psychology](day_1/day_1b.ipynb)<br>
04:00 PM - 04:15 PM: Break<br>
04:15 PM - 05:00 PM: Walkthrough<br>
...
12:00 PM - 12:30 PM: Discussion: Find applications in small groups<br>
...
1. Make sure you have a hugging Face account (https://huggingface.co/join). We would recommend that you sign up with your institutional email address to maximize the chances that Step 2 (below) is successful.
2. Go to the [`meta-llama/Llama-3.2-3B-Instruct` model page](https://huggingface.co/meta-llama/Llama-3.2-3B-Instruct) and fill in the 'COMMUNITY LICENSE AGREEMENT' form at the top of the page to get access to the model (this may take an hour or so). 
...
!git clone https://github.com/Zak-Hussain/LLM4BeSci_Zurich2025.git
```
8. Go back to your Google Drive and navigate to the folder "LLM4BeSci_Zurich2025" (this is your own copy, so you can edit it how you like and the changes won't affect anyone else's copies). You should see the directories containing the relevant notebooks (.ipynb files) and data (it may take  a couple of minutes for the files to appear) for the exercises of each day.
